...
<div class="flex h-full flex-col">
	<!-- Controls -->
	<div class="flex flex-wrap items-center gap-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3">
		<div class="flex items-center gap-2">
			<label for="export-quality" class="text-xs font-medium text-gray-600 dark:text-gray-300">Quality:</label>
			<select id="export-quality" bind:value={quality} class="rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 px-2 py-1.5 text-xs">
		...
		<div class="ml-auto flex gap-2">
			<button
				...
				disabled={exporting}
				class="cursor-pointer rounded-lg bg-gray-100 dark:bg-gray-700 px-4 py-2 text-xs font-medium text-gray-700 dark:text-gray-200 transition-colors hover:bg-gray-200 dark:hover:bg-gray-600 disabled:opacity-50"
			>
				Preview All
			</button>
			<button
	...
	<!-- Preview Grid -->
	<div class="flex-1 overflow-auto bg-gray-200 dark:bg-gray-800 p-6">
